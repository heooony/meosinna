                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="single-product.html">Blog Details</a>
                                </li>
                    ...
                    <form class="row login_form" action="register" id="register_form" method="post">
                        ...
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="rnumber-front" name="rnumber-front"
                                   placeholder="front" onfocus="this.placeholder = 'front'"
                                   onblur="this.placeholder = ''" style="width: 40%; display: block">
                        </div>-
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="rnumber-back" name="rnumber-back"
                                   placeholder="back" onfocus="this.placeholder = 'back'"
                                   onblur="this.placeholder = ''" style="width: 40%">
                        </div>
                        <div class="col-md-12 form-group">
