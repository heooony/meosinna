            ...
            <div class="common-filter">
              ...
              <form action="#">
                <ul>
                  ...
                  <li class="filter-list"><input class="pixel-radio" type="radio" id="samsung" name="myInfo"><label for="contact"><a href="${pageContext.request.contextPath}/myPrivateQA.jsp">일대일문의</a></label></li>
