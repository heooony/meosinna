      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <ul class="nav-shop">
              <li class="nav-item"><button onclick="location.href='category.jsp'"><i class="ti-search"></i></button></li>
              <li class="nav-item"><button onclick="location.href='cart.jsp' "><i class="ti-shopping-cart"></i><span class="nav-shop__circle">${sessionScope.cartQty}</span></button> </li>
              <%if(session.getAttribute("member") == null) {%>
