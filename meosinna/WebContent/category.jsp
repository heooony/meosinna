              ...
              <div class="head"></div>
               <form action="${pageContext.request.contextPath}/front" id="brandForm" method="post"> 
                ...
                <ul>
                  ...
                  <li class="filter-list"><input class="pixel-radio" type="radio" id="Nike X Off-WhiteThe" name="brand"><label for="Nike X Off-WhiteThe">Nike X Off-WhiteThe<span></span></label></li>
